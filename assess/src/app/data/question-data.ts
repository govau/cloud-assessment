...
export const QuestionData: ICSVItem[] = [
  ...
  },
  {
    ...
    'Sub_category': '',
    'Quality': 'Cloud model',
    'Description': '<p>Cloud services are categorised into three models - Software as a Service, Platform as a Service and Infrastructure as a Service.</p>\n<p><strong>Select the cloud model for the service you are assessing.</strong></p>',
    'Reference': '<p>Learn more about cloud models in section two of the <a href="https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-145.pdf" target="_blank">NIST Definition of Cloud Computing</a>.</p>',
    'Condition': '',
    'Relationship': '',
    'Value_type': 'XOR',
  ...
  },
  {
    ...
    'Sub_category': '',
    'Quality': 'Viability',
    'Description': '<p>It’s important to check that your vendor is financially stable. You can do this by checking if the vendor: <ul><li>has a track record of stability</li>\n<li>is in a healthy financial position.</ul></p>\n<p><strong>How well do you think the vendor is able to display a stable and healthy financial situation?</strong></p>',
  ...
  },
  {
    ...
    'Sub_category': '',
    'Quality': 'Adoption',
    'Description': '<p>Consider whether the service is being used by other government agencies or reputable companies. This may provide assurance and help assess risk.</p>\n<p><strong>How well do you think the vendor\'s services are being used by other agencies?</strong></p>',
  ...
  },
  {
    ...
    'Description': '<p>Consider the vendor\'s future plans for the cloud service and how it aligns with your internal business strategy.</p>\n<p><strong>How well do you think the vendor future plans aligns with your business strategy?</strong></p>',
    'Reference': '<p>Visit the vendor\'s website and review their product roadmap. If they don\'t have one contact them to see if they have this information.</p>',
    'Condition': '',
    'Relationship': '',
    'Value_type': 'Integer',
    'Value_options': '1, 2, 3, 4, 5',
  ...
  },
  {
    ...
    'Description': '<p>Having a work history with a potential vendor can help assess risk.This may provide assurance to the quality of the service being provided; however you should note that lack of an existing relationship doesn\'t imply a lower quality of service.</p>\n<p><strong>How do you think the service rates in terms of an existing relationship?</strong></p>',
  ...
  },
  {
    ...
    'Description': '<p>When procuring a service, you need to ensure value for money.</p>\n\n<p><strong>How well do you think the service provides value for money?</strong></p>',
  ...
  },
  {
    'Category': 'Operability',
    'Sub_category': '',
    'Quality': 'Orchestration and automatino',
